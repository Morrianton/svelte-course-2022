...
var app = (function () {
    ...
    // (51:0) {#each boxes as box (box)}
    function create_each_block(key_1, ctx) {
    	let div;
    	let t0_value = /*box*/ ctx[5] + "";
    	let t0;
    	let t1;
    	let div_transition;
    	let current;
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 51, 4, 1259);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*discard*/ ctx[3].bind(this, /*box*/ ctx[5]))) /*discard*/ ctx[3].bind(this, /*box*/ ctx[5]).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*boxes*/ 1) && t0_value !== (t0_value = /*box*/ ctx[5] + "")) set_data_dev(t0, t0_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(51:0) {#each boxes as box (box)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 47, 0, 1143);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*cubicIn, discard, boxes*/ 9) {
