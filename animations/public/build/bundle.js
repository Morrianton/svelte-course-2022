...
var app = (function () {
    ...
    /* src/Spring.svelte generated by Svelte v3.46.4 */
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$1, 81, 6, 1470);
    			this.first = div;
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 79, 2, 1404);
    			attr_dev(div1, "class", "page svelte-1a1ekzd");
    			add_location(div1, file$1, 78, 0, 1383);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let cardPos = spring(
    		...
    		{
    			stiffness: 0.1, // value between 0 and 1
    			damping: 0.9, // value between 0 and 1
    			precision: 0.001
    		}
    	);
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!p_transition) p_transition = create_bidirectional_transition(
    					p,
    					fly,
    					// transition allows for cancelling animations
    					{ x: 300 },
    					true
    				);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 80, 4, 1917);
    		},
    		m: function mount(target, anchor) {
    		...
    		o: function outro(local) {
    			span_outro = create_out_transition(span, fade, { delay: 250 });
    			current = false;
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 87, 4, 2018);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			current = true;
    		...
    		o: function outro(local) {
    			span_outro = create_out_transition(span, fade, // in and out do not allow for cancellable animations
    			{ delay: 250 });
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*cubicIn, discard, boxes, console*/ 65) {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "svelte-ddmo9r");
    			add_location(div, file, 97, 8, 2235);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		i: function intro(local) {
    			...
    			if (local) {
    				add_render_callback(() => {
    					if (!div_transition) div_transition = create_bidirectional_transition(div, fly, { easing: cubicIn, x: -200, y: 0 }, true);
    		...
    		o: function outro(local) {
    			if (local) {
    				if (!div_transition) div_transition = create_bidirectional_transition(div, fly, { easing: cubicIn, x: -200, y: 0 }, false);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(97:4) {#each boxes as box (box)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*showParagraph*/ ctx[2] && create_if_block_3(ctx);
    	let if_block1 = /*showAdded*/ ctx[3] && create_if_block_2(ctx);
    	let if_block2 = /*showDiscarded*/ ctx[4] && create_if_block_1(ctx);
    	let if_block3 = /*showParagraph*/ ctx[2] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 61, 0, 1545);
    			add_location(hr, file, 75, 0, 1807);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 77, 0, 1813);
    			add_location(button1, file, 78, 0, 1856);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (/*showDiscarded*/ ctx[4]) {
    				if (if_block2) {
    					if (dirty & /*showDiscarded*/ 16) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function addBox() {
    		...
    		$$invalidate(1, boxInput.value = '', boxInput);
    		$$invalidate(3, showAdded = true);

    		setTimeout(
    			() => {
    				$$invalidate(3, showAdded = false);
    			},
    			500
    		);
    	}
    	...
    	function discard(value) {
    		...
    		$$invalidate(4, showDiscarded = true);

    		setTimeout(
    			() => {
    				$$invalidate(4, showDiscarded = false);
    			},
    			500
    		);
    	}
    	...
    	const click_handler = () => $$invalidate(2, showParagraph = !showParagraph);
    	...
    	const introend_handler = () => console.log('Adding the element end.');
    	const outrostart_handler = () => console.log('Discarding the element starts.');
    	const outroend_handler = () => console.log('Discarding the element ends.');
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('showAdded' in $$props) $$invalidate(3, showAdded = $$props.showAdded);
    		if ('showDiscarded' in $$props) $$invalidate(4, showDiscarded = $$props.showDiscarded);
    	};
